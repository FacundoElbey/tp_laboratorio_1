...
/// \return retorna el número entero que es ingresado
...
///
/// \param mensaje Mensaje que se va mostrar al pedir el dato
/// \return retorna el número flotante que es ingresado
...
/// \return
int PedirString (char mensaje[], char stringIngresado[])//Para las horas y sueldo y chequear que son números.
{
	int retorno = 0;
    printf("%s \n", mensaje);
    fflush(stdin);
